package com.appcreator.photobook.db;
 ...
 * 메모 데이터베이스
 */
public class PhotoBookDB {

	public static final String TAG = "PhotoBookDB";

	/**
	 * 싱글톤 인스턴스
	 */
	private static PhotoBookDB database;
     ...
     * 생성자
     */
	private PhotoBookDB(Context context) {
	 ...
	 * 인스턴스 가져오기
	 */
	public static PhotoBookDB getInstance(Context context) {
		if (database == null) {
			database = new PhotoBookDB(context);
		}
